...
from helper_func import decode, get_messages, subsall, subsch, subsch1, subsgc
...
@Bot.on_message(filters.command("start") & filters.private & subsall & subsch & subsch1 & subsgc)
